...
func run(cfg config.Config) error {
	...
	repService := rlc.NewReputacionService(recursos.Almacen, recursos.Usuarios)
	luService := rlc.NewLogro_UsuarioService(recursos.Almacen, recursos.Almacen, recursos.Usuarios)
	lService := rlc.NewLogroService(recursos.Almacen)
	caService := rlc.NewCalificacionService(recursos.Almacen, recursos.Usuarios, recursos.Almacen)
